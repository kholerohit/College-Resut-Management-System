      ...
      <div class="col-sm-12">
        ...
        <div class="table-responsive ">
          ...
          $row1=mysqli_fetch_array($execute,MYSQLI_ASSOC);
                  ...
                  $subject_id1_t = $i3s1 + $i4s1 + $e2s1 + $isa2s1;
                  $subject_id2_t = $i3s2 + $i4s2 + $e2s2 + $isa2s2;
                  $subject_id3_t = $i3s3 + $i4s3 + $e2s3 + $isa2s3;
                  $subject_id4_t = $i3s4 + $i4s4 + $e2s4 + $isa2s4;
                  $subject_id5_t = $i3s2 + $i4s2 + $e2s2 + $isa2s5;
          ...
          <td><?php  echo "s1"; ?></td>
					<td><?php  echo htmlentities($i3s1); ?></td>
					<td><?php  echo htmlentities($i4s1); ?></td>
          <td><?php  echo '-'; ?></td>
          <td><?php  echo '-'; ?></td>
					<td><?php  echo htmlentities($isa2s1); ?></td>
					<td><?php  echo htmlentities($e2s1); ?></td>
          ...
          <td><?php  echo "s2"; ?></td>
          <td><?php  echo htmlentities($i3s2); ?></td>
          <td><?php  echo htmlentities($i4s2); ?></td>
          <td><?php  echo '-'; ?></td>
          <td><?php  echo '-'; ?></td>
          <td><?php  echo htmlentities($isa2s2); ?></td>
          <td><?php  echo htmlentities($e2s2); ?></td>
          ...
          <td><?php  echo "s3"; ?></td>
          <td><?php  echo htmlentities($i3s3); ?></td>
          <td><?php  echo htmlentities($i4s3); ?></td>
          <td><?php  echo '-'; ?></td>
          <td><?php  echo '-'; ?></td>
          <td><?php  echo htmlentities($isa2s3); ?></td>
          <td><?php  echo htmlentities($e2s3); ?></td>
          ...
          <td><?php  echo "s4"; ?></td>
          <td><?php  echo htmlentities($i3s4); ?></td>
          <td><?php  echo htmlentities($i4s4); ?></td>
          <td><?php  echo '-'; ?></td>
          <td><?php  echo '-'; ?></td>
          <td><?php  echo htmlentities($isa2s4); ?></td>
          <td><?php  echo htmlentities($e2s4); ?></td>
          ...
          <td><?php  echo "s5"; ?></td>
          <td><?php  echo htmlentities($i3s5); ?></td>
          <td><?php  echo htmlentities($i4s5); ?></td>
          <td><?php  echo '-'; ?></td>
          <td><?php  echo '-'; ?></td>
          <td><?php  echo htmlentities($isa2s5); ?></td>
          <td><?php  echo htmlentities($e2s5); ?></td>
