...
<?php
    ...
    $addrs = mysqli_real_escape_string($conn, $_POST["addrs"]);
		...
		elseif(strlen($id)<3)
		{
			$_SESSION["ErrorMessage"]=" id should atleast 3 digit long";
			header("Location:addNewTeacher.php");
			exit;
		}
		else
		{
            ...
            echo $id.$dateTime.$name.$mo_no.$email.$stream.$addrs.$year.$passwd.$ImageNameNew.$admin_panel_id.$extra1.$extra2.$extra3;
						$query = "  INSERT INTO `teacher_info` (`id`, `datetime`, `name`, `mo_no`, `email`, `subjects`, `addrs`, `passwd`, `photo`, `admin_panel_id`, `extra1`, `extra2`, `extra3`)
            VALUES('$id', '$dateTime', '$name','$mo_no','$email','$subjects','$addrs', '$passwd','$ImageNameNew','$admin_panel_id', '$extra1','$extra2','$extra3')";
...
<div class="container-fluid">
	<div class="row">
		...
		<h1 class="sidebar-brand">The<br><?php echo ucwords($_SESSION["Username"]) ;?></h1>
                  ...
                  <li class="nav-item btn ">
						        <a class="nav-link btn btn-primary" href="addNewTeacher.php">
		...
		<div class="col-sm-10">
			...
			<h1>Add New Post</h1>
				...
				<?php
				 ...
				 ?>
			<div>
				<form action="addNewTeacher.php" method="POST"  enctype="multipart/form-data">
					<fieldset>
          ...
          <div class="form-group col-lg-4">
					...
					<input class="btn btn-primary" type="submit" name="submit" value="Add Teacher Bio">
					</fieldset>
				</form>
			</div>
			</div>
