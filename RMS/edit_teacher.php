			...
			if(in_array($ImageActualExt, $allowed))
			{
				if ($ImageError === 0)
				{
					if ($ImageSize < 10000000)
					{
						...
						$editid = $_GET['edit'];
						$query = "UPDATE teacher_info SET dateTime='$dateTime', name='$name', mo_no='$mo_no',
            email='$email',subjects='$subjects',photo='$ImageNameNew',addrs='$addrs'  WHERE id='$editid'";
		...
		<div class="col-sm-10">
			...
			<div>
                ...
                $addrs = $row["addrs"];
			          ...
			          ?>
            <form action="edit_teacher.php?edit=<?php echo $search;?>" method="POST"  enctype="multipart/form-data">
        			<fieldset>
                ...
                <div class="form-group">
                  ...
                  class="form-control col-sm-4" type="text" name="email" id="email" placeholder="email">
        				...
        				<div class="form-group">
      					...
      					<div class="form-group">
      						<label class="fieldinform" for="image_select">Select Profile Image:</label>
