...
<?php
	if(isset($_POST["submit"]))
	{
		...
		{
			global $conn;
			$query = "INSERT INTO login_teacher(datetime, name,creator_name)
				VALUES('$dateTime','$category','$admin')";
			$execute = mysqli_query($conn,$query) or die('Error');

			if($execute){
				$_SESSION["SuccessMessage"] = " Teacher has been added...";
			}
			else{
				$_SESSION["ErrorMessage"] = "Teacher not added";
			}
...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-sm-10">
			...
			<div>
				<form action="mteacher.php" method="POST">
					<fieldset>
...
yes, only one PRIMARY KEY is allowed per table, then how the other keys are constrained;
 in such case we will use UNIQUE and NOT NULL combination.
