    ...
    <div class="col-sm-2">
						  ...
						  <nav class="sidebar-nav">
						    <ul class="">
						      <li class="nav-item mt-auto btn ">
						        <a class="nav-link  btn btn-primary" href="dashboard.php">
						          <i class=""></i> Dashboard
						        </a>
						      </li>
									<li class="nav-item mt-auto btn ">
		...
		<div class="col-sm-10">
			...
			<div class="table-responsive">
				<table id="mytable" class="table table-striped table-hover">
					<tr>
						...
						<th class="tht">Stream</th>
						<th class="tht">Addrs</th>
						<th class="tht">Year</th>
            ...
            <th class="tht">Detail</th>
					...
					$srn = 0;
					global $conn;
					$query = "SELECT *  FROM student_info ORDER BY PRN desc";
          ...
          <td><?php if(strlen($stream)>12){$stream=substr($stream, 0, 12).'...';} echo htmlentities($stream); ?></td>
          <td><?php if(strlen($addrs)>12){$addrs=substr($addrs, 0, 12).'...';} echo htmlentities($addrs); ?></td>
          <td><?php if(strlen($year)>12){$year=substr($year, 0, 12).'...';} echo htmlentities($year); ?></td>
					<td><img style="width: 100px; height: 50px;" src="upload/<?php echo htmlentities($image);?>"></td>
					<td>
						<a href="edit_student.php?edit=<?php echo $PRN ;?>"><span class="btn btn-warning">Edit ...</span></a>
						<a href="delete_student.php?delete=<?php echo $PRN ;?>"><span class="btn btn-danger">Delete</span></a>
					</td>
					<td>
...
height: 0px auto">
<span>Developed BY | Result Management Team | &copy;2018-2023 --All right reserved.</span><br>
