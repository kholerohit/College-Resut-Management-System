...
<?php
    ...
    $image = $_POST["photo"];
		...
		else
		{
			...
			$query = "DELETE FROM student_info WHERE PRN='$deleteid'";
			$execute = mysqli_query($conn,$query) or die('Error0');
			move_uploaded_file($_FILES["Image"]["tmp_name"],$Target);
			if($execute){
				$_SESSION["SuccessMessage"] = " Student Bio deleted successfully...";
				header("Location:dashboard.php");
				exit;
			}
			else{
		...
		<div class="col-sm-10">
			...
			<div>
                ...
                $name = $row["name"];
			          ...
			          ?>
				<form action="delete_student.php?delete=<?php echo $search;?>" method="POST"  enctype="multipart/form-data">
					<fieldset>
          ...
          <div class="form-group">
            ...
            class="form-control col-sm-4" type="text" name="email" id="email" placeholder="email">
					...
					<div class="form-group">
						...
						<textarea  class="form-control col-sm-4" name="Post" id="post_area"><?php echo @$addrs ;?></textarea>
					</div>
